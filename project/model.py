...
# Wczytanie danych
file_path = '../../../Downloads/dataset.csv'  # Podaj ścieżkę do pliku
...
for i in range(len(data) - look_back - forecast_days + 1):
    ...
    feature = data[['QQ', 'efficiency']].iloc[i:i + look_back].values.flatten()
...
plt.title("Random Forest Regression - Prognoza kolejnych 7 dni")
plt.xlabel("Data")
